...
@implementation ReactNativeLottieSplashScreen
- (dispatch_queue_t)methodQueue {
  return dispatch_get_main_queue();
}
RCT_EXPORT_MODULE(ReactNativeLottieSplashScreen)
...
RCT_EXPORT_METHOD(hide) { [ReactNativeLottieSplashScreen hide]; }

RCT_EXPORT_METHOD(show) { [ReactNativeLottieSplashScreen show]; }
